    ...
    <div className="min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-16 sm:py-24">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Feature 1 */}
          <div className="p-8 rounded-2xl bg-white border border-slate-100 hover:border-emerald-200 hover:shadow-lg transition-all group">
            <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform">
              <Zap className="w-7 h-7" />
            </div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">LSTM Deep Learning</h3>
          ...
          <div className="p-8 rounded-2xl bg-white border border-slate-100 hover:border-blue-200 hover:shadow-lg transition-all group">
            <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform">
              <MapPin className="w-7 h-7" />
            </div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">Dashboard Web-GIS</h3>
            <p className="text-slate-600">
          ...
          {/* Feature 3 */}
          <div className="p-8 rounded-2xl bg-white border border-slate-100 hover:border-amber-200 hover:shadow-lg transition-all group">
            <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform">
              <BarChart3 className="w-7 h-7" />
            </div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">Data Real-Time</h3>
            <p className="text-slate-600">
      ...
      {/* How It Works */}
      <section className="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white py-16 sm:py-24">
      ...
      <section className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-16 sm:py-24">
        ...
        <div className="rounded-3xl overflow-hidden shadow-2xl">
          ...
          />
          <div className="bg-gradient-to-t from-slate-900/80 to-transparent p-8 text-white text-center">
            <h3 className="text-2xl font-bold mb-3">Jelajahi Prediksi Per Kecamatan</h3>
            <p className="text-slate-200 mb-6">
              Lihat detail prediksi panen, status kesehatan tanaman, dan analisis cuaca untuk setiap wilayah
            </p>
            <button
              onClick={() => onNavigate("peta")}
              className="px-8 py-3 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-semibold transition-all inline-flex items-center gap-2"
            >
              Buka Peta Lengkap <ArrowRight className="w-5 h-5" />
            </button>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={idx} className="bg-slate-800 rounded-xl p-6 border border-slate-700 hover:border-emerald-500 transition-all">
                <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-emerald-400 to-blue-500 flex items-center justify-center text-white font-bold mb-4">
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-emerald-600 to-blue-600 text-white py-16 sm:py-24">
        <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => onNavigate("peta")}
              className="px-8 py-4 rounded-xl bg-white text-emerald-700 font-semibold hover:bg-emerald-50 transition-all flex items-center justify-center gap-2"
            >
              Jelajahi Peta <ArrowRight className="w-5 h-5" />
            </button>
            <button
              onClick={onAuthModalOpen}
              className="px-8 py-4 rounded-xl bg-emerald-700 hover:bg-emerald-800 text-white font-semibold transition-all border border-emerald-500"
            >
              Login sebagai Admin
            </button>
          </div>
